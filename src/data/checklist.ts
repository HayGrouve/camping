...
export const indoors: IChecklistItem[] = [
...
export const outdoors: IChecklistItem[] = [
  {
    id: uuidv4(),
  ...
  { id: uuidv4(), text: 'Matches, firestarter or a lighter', isChecked: false },
  {
    id: uuidv4(),
...
export const furniture: IChecklistItem[] = [
  {
    id: uuidv4(),
...
export const clothesAndShoes: IChecklistItem[] = [
  {
    id: uuidv4(),
    text: 'T-shirts',
    isChecked: false,
...
export const food: IChecklistItem[] = [
  {
    id: uuidv4(),
...
export const hygieneAndToiletries: IChecklistItem[] = [
  {
    id: uuidv4(),
    text: 'Hand soap',
    isChecked: false,
...
export const recreational: IChecklistItem[] = [
  {
    id: uuidv4(),
...
export const cleanUp: IChecklistItem[] = [
  ...
  { id: uuidv4(), text: 'Garbage bags', isChecked: false },
];
export const safety: IChecklistItem[] = [
...
export const firstAid: IChecklistItem[] = [
  ...
  { id: uuidv4(), text: 'text', isChecked: false },
];
export const personal: IChecklistItem[] = [
